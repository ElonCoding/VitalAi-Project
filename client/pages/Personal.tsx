      ...
      <section className="container py-6">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Securely book with campus counsellors. Choose anonymous booking to
            ...
            <div className="rounded-2xl border bg-card p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  30‑min walk, 5 days/week
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 inline-block h-2 w-2 rounded-full bg-brand" />{" "}
                  Check blood pressure 3×/week and log results
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 inline-block h-2 w-2 rounded-full bg-brand" />{" "}
                  Mediterranean‑style meals; track hydration
                </li>
              </ul>
              <div className="mt-5 flex gap-2">
                <Button size="sm" variant="outline" className="gap-2">
                  <Pencil className="h-4 w-4" /> Update goals
                </Button>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl border bg-card p-6 shadow-sm">
                ...
                <div className="mt-4 text-xs text-muted-foreground">
                  Set reminders in Settings to avoid missed doses.
                </div>
              </div>
              <div className="rounded-2xl border bg-card p-6 shadow-sm">
                <div className="flex items-center gap-2 text-brand">
                  <FlaskConical className="h-5 w-5" />
                  <h4 className="text-sm font-semibold">Recent labs</h4>
                </div>
                <ul className="mt-3 space-y-3 text-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border bg-card p-6 shadow-sm">
              ...
              <div className="mt-4 text-xs text-muted-foreground flex items-center gap-2">
                <MapPin className="h-3.5 w-3.5" /> Mercy Medical Center, SF
              </div>
            </div>
            ...
            <div className="rounded-2xl border bg-card p-6 shadow-sm">
              ...
              <div className="mt-3 grid gap-3 text-sm">
                ...
                >
                  <Phone className="h-4 w-4" /> Call nurse line
                </a>
                <a
                  className="flex items-center gap-2 text-brand"
                  href="mailto:care@vitalai.health"
                >
                  <Mail className="h-4 w-4" /> care@vitalai.health
                </a>
              </div>
            </div>
          </div>
...
function Team({
  ...
  return (
    <li className="flex items-center justify-between gap-3">
      ...
      <a className="text-xs text-brand" href={`tel:${phone}`}>
        {phone}
      </a>
    </li>
  );
  ...
  return (
    <div className="rounded-xl border bg-background p-4">
      ...
      <svg viewBox="0 0 120 40" className="mt-2 h-16 w-full">
        <path
          d="M0 28 L15 26 L25 30 L35 18 L45 24 L55 14 L65 22 L75 12 L85 20 L95 16 L105 22 L120 18"
          fill="none"
          stroke={`hsl(${color})`}
          strokeWidth="2"
        />
