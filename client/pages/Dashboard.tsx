      ...
      <section className="container py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <Button onClick={() => setShowBooking(true)} variant="outline">
              Book appointment
            </Button>
      ...
      <section className="container pb-16">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card
            ...
            title="Vitals"
            body={
              <span className="text-xl font-semibold">HR 64 • SpO₂ 98%</span>
            }
            footer="Stable last 7 days"
          />
          <Card
            icon={<CalendarClock className="h-5 w-5" />}
            title="Next visit"
            body={<span className="text-xl font-semibold">Tue 10:30</span>}
            footer="With Dr. Chen"
          />
          <Card
            icon={<Pill className="h-5 w-5" />}
            title="Medications"
            body={<span className="text-xl font-semibold">3 active</span>}
            footer={
              <Link to="/me" className="text-xs text-brand">
                Manage
              </Link>
            }
          />
          <Card
            ...
            title="Labs due"
            body={<span className="text-xl font-semibold">2</span>}
            footer="Next: A1C"
          />
        </div>
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            View or cancel confidential appointments you've made. Anonymous
            bookings remain private.
          </p>
          <div className="mt-4">
            <BookingList />
          </div>
  ...
  return (
    <div className="rounded-xl border bg-background p-4">
      ...
      <svg viewBox="0 0 120 40" className="mt-2 h-16 w-full">
        <path
          d="M0 28 L10 24 L20 26 L30 18 L40 22 L50 14 L60 20 L70 12 L80 22 L90 16 L100 22 L120 18"
          fill="none"
